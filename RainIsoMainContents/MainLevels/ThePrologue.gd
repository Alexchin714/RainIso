...
func _ready():
	$Player/CameraAnchor/Camera2D.current = true
...
func _on_eArea_body_entered(body):
	$Level/StaticBody2D/TileMapThird/AnimationPlayer.play("e")

func _on_SliderArea_body_entered(body):
	SceneTransition
