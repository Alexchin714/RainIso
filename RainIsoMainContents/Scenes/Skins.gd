...
onready var price2 = str2var($Header/Skins/RichTextLabel/Control/Panel2/Label.text)
onready var price3 = str2var($Header/Skins/RichTextLabel/Control/Panel3/Label.text)
onready var price4 = str2var($Header/Skins/RichTextLabel/Control/Panel4/Label.text)
...
# ------ Check for all bought items and make them bought
	for item in range(panels.get_child_count()-3):
