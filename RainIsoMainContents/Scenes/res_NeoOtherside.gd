...
func _ready():
	#var map_with_visible_notifier = load("res://RainIsoMainContents/Scenes/NeoRushOthersideTileMap.tscn")
	#var map_size = 1
	#var chunk_size = 1
...
func _on_OthersideSwitchNeoRush_body_entered(body):
	$CamContainer/ParallaxBackground/BG.visible = false
	$CamContainer/ParallaxBackground/BG2.visible = false
	$CamContainer/ParallaxBackground/BG3.visible = false
	$CamContainer/ParallaxBackground/BG4.visible = false
	$CamContainer/ParallaxBackground/BG5.visible = false
	$CamContainer/ParallaxBackground/BGPhase21.visible = true
	$CamContainer/ParallaxBackground/BGPhase22.visible = true
	$CamContainer/ParallaxBackground/BGPhase23.visible = true
	$CamContainer/ParallaxBackground/BGPhase24.visible = true
	$CamContainer/ParallaxBackground/BGPhase25.visible = true

func _on_BGPHASE2ENTER_body_entered(body):
	$CamContainer/ParallaxBackground/BG.visible = false
	$CamContainer/ParallaxBackground/BG2.visible = false
	$CamContainer/ParallaxBackground/BG3.visible = false
	$CamContainer/ParallaxBackground/BG4.visible = false
...
func _on_BossEnter_body_entered(body):
	$TheDremGuardian/AnimationTree
